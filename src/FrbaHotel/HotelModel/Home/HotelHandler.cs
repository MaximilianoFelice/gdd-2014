...
namespace HotelModel.Home
{
    public class HotelHandler
    {
        ...
        {
            _hotels_adapter.Update(new DataRow[] {aRow});
        }
        ...
        public static DataTable filteredSearch(String name, Int32? stars, String city, String country)
        {
        ...
        public static Boolean hotelForManteinance(Int32 id_hotel, DateTime start, DateTime end, String descr)
        {
        ...
        private HotelHandler(DataRow row)
        {
            _hotelRow = row;
        }
        ...
        public void Update()
        {
            ...
            if ((int)Hotel["id_hotel"] == -1)
            {
                ...
                _hotels_adapter.Update(new DataRow[] { Hotel });
